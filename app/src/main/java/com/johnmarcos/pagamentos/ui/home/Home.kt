...
import com.johnmarcos.pagamentos.ui.home.categoriaPagamento.CategoriaPagamento
...
fun Home(
    ...
    val categoriaSelecionada = viewState.categoriaSelecionada

    if (viewState.categorias.isNotEmpty() && categoriaSelecionada != null) {
        Surface(modifier = Modifier.fillMaxSize()) {
            HomeContent(
                categoriaSelecionada = categoriaSelecionada,
                categorias = viewState.categorias,
...
fun HomeContent(
    ...
    Scaffold(
        ...
        floatingActionButton = {
            FloatingActionButton(
                onClick = { navController.navigate(route = "pagamento") },
...
@Composable
private fun CategoriaTabs(
    categorias: List<Categoria>,
    categoriaSelecionada: Categoria,
    onCategoriaSelecionada: (Categoria) -> Unit
) {
    val selectedIndex = categorias.indexOfFirst { it == categoriaSelecionada }
    ScrollableTabRow(
